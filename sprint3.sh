...
mkdir -p src/features/customer/components

# ============================================
# 1. ProductCard.jsx
# ============================================
cat > src/features/customer/components/ProductCard.jsx << 'EOF'
...
# 2. MenuGrid.jsx
# ============================================
cat > src/features/customer/components/MenuGrid.jsx << 'EOF'
import React from 'react';
...
# 3. ProductModal.jsx
# ============================================
cat > src/features/customer/components/ProductModal.jsx << 'EOF'
...
export default function ProductModal({ product, onClose, onAdd }) {
  ...
  const totalPrice = variant
    ? (variant.price + (flavor?.extra_price || 0)) * qty
    : 0;
        ...
        <div className="p-5 overflow-y-auto flex-1 no-scrollbar">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-4 bg-gray-100 dark:bg-gray-700 rounded-full px-4 py-2">
              ...
              <span className="font-black text-lg w-6 text-center text-gray-800 dark:text-white">
                {qty}
              </span>
              <button
...
# 4. CartSheet.jsx
# ============================================
cat > src/features/customer/components/CartSheet.jsx << 'EOF'
import React from 'react';
...
# 5. CheckoutSheet.jsx
# ============================================
cat > src/features/customer/components/CheckoutSheet.jsx << 'EOF'
import React from 'react';

export default function CheckoutSheet({
  cartTotal, deliveryFee, discountAmount, grandTotal,
  name, phone, phoneError, onNameChange, onPhoneChange,
  orderType, onOrderTypeChange, distanceKm, onDistanceChange,
      ...
      <div className="bg-white dark:bg-gray-800 w-full max-w-lg rounded-t-3xl max-h-[92vh] flex flex-col">
        ...
        <div className="p-5 overflow-y-auto flex-1 no-scrollbar space-y-4">
          ...
          <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl space-y-2 text-sm text-gray-800 dark:text-gray-200">
            ...
            {orderType === 'delivery' && (
              <div className="flex justify-between"><span>رسوم التوصيل:</span><b>{deliveryFee} SR</b></div>
            )}
            {discountAmount > 0 && (
...
# 6. TrackingSheet.jsx
# ============================================
cat > src/features/customer/components/TrackingSheet.jsx << 'EOF'
import React from 'react';
...
# ============================================
# 7. CustomerApp.jsx (الرئيسي المُعاد كتابته)
# ============================================
cat > src/features/customer/CustomerApp.jsx << 'EOF'
import React, { useState, useEffect } from 'react';
...
# ============================================
# 8. Re-export في المكان القديم
# ============================================
cat > src/components/CustomerApp.jsx << 'EOF'
// Re-export من الموقع الجديد للحفاظ على التوافق
export { default } from '../features/customer/CustomerApp';
EOF

echo ""
echo "✅ Sprint 3: CustomerApp split into modular components"
echo ""
echo "الملفات الجديدة:"
ls -la src/features/customer/
echo ""
ls -la src/features/customer/components/
